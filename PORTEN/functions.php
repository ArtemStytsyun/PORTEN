...
//function for main footer
function porten_footer($exist_categories, $categories)
{
    echo <<<EOT
    <!-- FOOTER -->
        <footer class="footer">
    ...
    EOT;  
    show_avialable_categories($exist_categories, $categories);
    echo <<<EOT
