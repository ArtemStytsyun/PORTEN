...
<body>
	...
	<svg style="display: none">
		<symbol  id="profile" viewBox="0 0 510 510">
			<g>
					...
					<div class="container">
						<div class="header__inner">
							<div class="header__info">
									...
									<p class="info">8 (812) 123-45-67</p>
									<p class="info">|</p>
									<p class="info">Работаем 7 дней в неделю </p>
									<p class="info">|</p>
								...
								<div class="header__reg">
									...
									<p class="reg">/</p>
									<a class="reg" href="Registration.php?pa=2" id="registration">Регистрация</a>
								</div>
								<?php } else{ ?>
									<div class="profile">

										<div>
											<a class="profile__link" href="myprofile.php">
												Мой профиль
												<svg class='profile__img'>
													<use xlink:href="#profile"></use>
												</svg>
											</a>
										</div>	

										<div><a class="profile__link" href="exit.php">Выйти</a></div>
									</div>
								<?php } ?>
						...
						<div class="container">
							<div class="header__inner">
								...
								<nav class="nav">
										...
										<ul>
											<li><a href="#" class="link">Понравилось</a>
											<li><a href="#" class="link">Личный кабинет</a>
											<li><a href="#" class="link">Настройка</a>
											
												<?php if(empty($_COOKIE['username'])){?>
											
												<li><a class="reg header__reg link" style="display:none" href="Registration.php?pa=1" id="login" >
														<span>Войти</span>
													</a>
												</li>

												<li>
													<a class="reg header__reg link" style="display:none" href="Registration.php?pa=2" id="registration">Регистрация</a>
												</li>	
												<?php } else{ ?>
												
												<li>
													<a class="profile__link profile link" href="myprofile.php" style="display:none">
														Мой профиль
														<svg class='profile__img'>
															<use xlink:href="#profile"></use>
														</svg>
												...
												<li><a class="profile__link profile link" href="exit.php" style="display:none">Выйти</a></li>
										...
										<div class="search__block">
											<form action="post">
											<input type="text" type="text" class="search__text search__text-none" name ="search" placeholder="Поиск">
										</form>
		...
		<footer class="footer">
			<div class="container">
				<div class="footer__inner">
					<div class = "footer__block aboutShop">
					...
					<div class = "footer__block categories">
						<h3 class = "title">Категоии</h3>
						<div class="category">
							<a href="#" class="category__item">часы</a>
							<a href="#" class="category__item">рраслеты</a>
							<a href="#" class="category__item">ремни</a>
							<a href="#" class="category__item">ювелирные изделия</a>
							<a href="#" class="category__item">запанки</a>
						</div>
					...
					<div class = "footer__block mailing">
						...
						<form action="">
							<div class="mailing__group">
								<input type="email" class="mailing__email" placeholder="Ваша почта" required><button class="mailing__button">подписаться</button>
							</div>
						</form>
